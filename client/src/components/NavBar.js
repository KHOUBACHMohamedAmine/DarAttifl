              ...
              <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav me-auto">
                      <li className="nav-item ms-2">
                          <a className="nav-link click-scroll" href="/">الصفحة الرئيسية</a>
                      </li>

                      <li className="nav-item ms-2">
                          <a className="nav-link click-scroll" href="/#section_2">من نحن</a>
                      </li>

                      <li className="nav-item ms-2">
                          <a className="nav-link click-scroll" href="/activites">أنشطة</a>
                      </li>

                      <li className="nav-item ms-2">
                          <a className="nav-link click-scroll" href="/#section_4">اتصل بنا</a>
                      </li>

                  </ul>
                    <ul class="navbar-nav navbar-nav-left">
                        <li class="nav-item nav-profile dropdown">
                        <a class="nav-link ms-4" href="#" data-toggle="dropdown" id="profileDropdown">
                            {user?.name}
                        </a>
                        ...
                        <div style={{cursor: 'pointer'}} onClick={logout} class="dropdown-item">
                            <i class="bi bi-power ms-2"></i>
                            تسجيل خروج
                        </div>
                        </div>
                        </li>
